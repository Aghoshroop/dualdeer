  ...
  return (
    <article className={styles.premiumContainer} ref={containerRef} itemScope itemType="https://schema.org/Product">
      ...
      <motion.nav 
        ...
        >
          <ChevronLeft size={16} color="#D4AF37" /> <span>Return</span>
        </button>

        <Link href="/" style={{ textDecoration: 'none' }}>
          <div style={{ textAlign: 'center' }}>
             <div className={styles.navLogoText} style={{ fontFamily: 'Cinzel', fontSize: '1.5rem', letterSpacing: '0.3em', color: '#fff', textShadow: '0 0 20px rgba(212,175,55,0.3)' }}>DUALDEER</div>
             <div className={styles.navLogoSub} style={{ fontFamily: 'Inter', fontSize: '0.55rem', letterSpacing: '0.5em', color: '#D4AF37', marginTop: '2px', textTransform: 'uppercase' }}>Elite Vault</div>
          </div>
        </Link>
