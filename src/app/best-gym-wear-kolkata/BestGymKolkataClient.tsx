...
export default function BestGymKolkataClient({ initialProducts }: { initialProducts: Product[] }) {
    ...
    <main className={styles.main}>
      <section className={styles.hero} style={{ background: '#0a0a0a', minHeight: '60vh' }}>
        <div className={styles.heroContent}>
          ...
          >
            BEST GYM WEAR KOLKATA
          </motion.h1>
          <motion.p className={styles.heroSubtitle} initial={{ opacity: 0 }} animate={{ opacity: 0.9 }} transition={{ duration: 1, delay: 0.3 }}>
            Unrivaled craftsmanship explicitly tailored for athletes demanding the absolute highest echelon of physical dominance and aesthetic authority in Kolkata.
          </motion.p>
        </div>
      </section>
      ...
      <section className={styles.section} style={{ maxWidth: '1000px', margin: '0 auto', fontSize: '1.1rem', lineHeight: '1.8' }}>
        <div style={{ marginBottom: '3rem' }}>
            <h2 className={styles.sectionTitle} style={{ fontSize: '2rem', marginBottom: '1.5rem' }}>Setting an Impossible New Standard in Kolkata</h2>
            <p style={{ marginBottom: '1.5rem' }}>
              For far too long, the activewear market has been overwhelmingly flooded with subpar, mass-produced garments that entirely fail to withstand the true rigors of elite athletic pressure. Discovering genuinely the <Link href="/best-gym-wear-kolkata" style={{ textDecoration: 'underline', color: 'inherit' }}>best gym wear in Kolkata</Link> has historically required importing heavily overpriced international luxury brands. DualDeer was precisely engineered to directly annihilate this glaring deficit. By merging heavily researched biomechanical principles with uncompromising, ultra-high-end fashion silhouettes and the world's best fabrics, we successfully engineered an incredibly powerful collection that simply outclasses everything currently existing in the city. 
            </p>
            <p>
              An elite professional athlete explicitly requires their physical armaments to silently support rapid kinetic output. From meticulously hunting for the ultimate compression t-shirt to sourcing breathable, sweat-evaporating bottoms, DualDeer's advanced proprietary fabrics effortlessly provide monumental athletic superiority. We rely exclusively upon ultra-dense, four-way hydrophobic synthetic weaves that aggressively wick moisture, effectively regulating critical core temperatures during violently high-intensity training intervals. 
            </p>
        </div>
        ...
        <div style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              The very foundation of finding premium activewear in Kolkata lies within longevity and structural resistance. Many basic garments immediately suffer from thread degradation and dangerous chafing when exposed to heavy barbell friction or intense repetitive aerobic motion. Through the heavy utilization of advanced flatlock seam construction and intricately body-mapped ergonomic paneling, DualDeer absolutely eliminates all internal chafing parameters. Furthermore, our signature masterpiece, the incredibly exclusive Elite Collection, has firmly cemented its legendary reputation amongst those who refuse to wear anything lacking absolute aerodynamic perfection.
            </p>
        </div>
      </section>
      ...
      <section className={styles.darkSection} style={{ padding: '4rem 2rem' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <div style={{ marginBottom: '2rem', background: 'rgba(var(--foreground-rgb), 0.05)', padding: '2rem', borderRadius: '8px' }}>
                <h3 style={{ fontSize: '1.2rem', marginBottom: '1rem', color: 'var(--color-text)' }}>Why is DualDeer considered the best activewear in Kolkata?</h3>
            ...
            <div style={{ background: 'rgba(var(--foreground-rgb), 0.05)', padding: '2rem', borderRadius: '8px' }}>
                ...
                <p style={{ opacity: 0.8, lineHeight: '1.6' }}>Every structural silhouette, prominently including our highly sought-after Elite collection pieces, undergoes violently rigorous friction, stretch, and thermal dynamic stress testing before it ever approaches the public market.</p>
            </div>
        </div>
      </section>
    </main>
