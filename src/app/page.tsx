      ...
      <SeoIntroBlock
        ...
        paragraphs={[
          <React.Fragment key="1">
            Welcome to DualDeer, the definitive destination for <Link href="/shop" style={{ textDecoration: 'underline', color: '#fff', textUnderlineOffset: '4px', fontWeight: 500 }}>premium activewear</Link> and high-end athleisure in India. Built upon a foundation of relentless innovation and an unwavering commitment to excellence, our brand is fundamentally redefining what it means to dress for performance. Our meticulously crafted gym apparel and streetwear don&apos;t just follow fleeting trends; they set rigorous new standards by seamlessly blending cutting-edge fabric technology with an avant-garde aesthetic that commands attention both inside and outside the gym.
          </React.Fragment>,
          ...
          <React.Fragment key="3">
            Our signature pieces feature seamless, chafe-free construction alongside intelligent, targeted compression zones intended for superior muscle stabilization and recovery. The aerodynamic, flattering silhouettes are built exclusively for the modern discerning individual. <Link href="/shop" style={{ textDecoration: 'underline', color: '#fff', textUnderlineOffset: '4px', fontWeight: 500 }}>Explore our iconic shop collection</Link> to discover how we continuously redefine the extreme boundaries of intense workout gear. By deploying state-of-the-art climate control technology directly into our exclusive weaves, our garments naturally and efficiently regulate your core body temperature during the most grueling conditions.
          </React.Fragment>,
