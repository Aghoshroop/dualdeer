      ...
      <SeoIntroBlock
        ...
        paragraphs={[
          ...
          <React.Fragment key="3">
            Our signature pieces feature seamless, chafe-free construction alongside intelligent, targeted compression zones intended for superior muscle stabilization and recovery. The aerodynamic, flattering silhouettes are built exclusively for the modern discerning individual. <Link href="/shop" style={{ textDecoration: 'underline', color: 'var(--color-text)', textUnderlineOffset: '4px', fontWeight: 500 }}>Explore our iconic shop collection</Link> to discover how we continuously redefine the extreme boundaries of intense workout gear. By deploying state-of-the-art climate control technology directly into our exclusive weaves, our garments naturally and efficiently regulate your core body temperature during the most grueling conditions.
          </React.Fragment>,
